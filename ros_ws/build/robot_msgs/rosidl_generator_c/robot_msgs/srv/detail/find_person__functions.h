...
#ifndef ROBOT_MSGS__SRV__DETAIL__FIND_PERSON__FUNCTIONS_H_
#define ROBOT_MSGS__SRV__DETAIL__FIND_PERSON__FUNCTIONS_H_
...
/// Initialize srv/FindPerson message.
/**
...
/// Finalize srv/FindPerson message.
/**
...
/// Create srv/FindPerson message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_msgs__srv__FindPerson_Request__init().
...
/// Destroy srv/FindPerson message.
/**
 * It calls
 * robot_msgs__srv__FindPerson_Request__fini()
...
/// Check for srv/FindPerson message equality.
/**
...
/// Initialize array of srv/FindPerson messages.
/**
...
/// Finalize array of srv/FindPerson messages.
/**
 * It calls
 * robot_msgs__srv__FindPerson_Request__fini()
...
/// Create array of srv/FindPerson messages.
/**
 * It allocates the memory for the array and calls
 * robot_msgs__srv__FindPerson_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/FindPerson messages.
/**
 * It calls
 * robot_msgs__srv__FindPerson_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/FindPerson message array equality.
/**
...
/// Copy an array of srv/FindPerson messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_msgs__srv__FindPerson_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_msgs
...
/**
 * It calls
 * robot_msgs__srv__FindPerson_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_msgs
...
/**
 * It allocates the memory for the array and calls
 * robot_msgs__srv__FindPerson_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_msgs
...
/**
 * It calls
 * robot_msgs__srv__FindPerson_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOT_MSGS__SRV__DETAIL__FIND_PERSON__FUNCTIONS_H_
