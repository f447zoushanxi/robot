...
#include "robot_msgs/srv/detail/detect_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_msgs::srv::DetectObject_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_msgs::srv::DetectObject_Request & ros_message)
{
  // Member: object_name
  cdr >> ros_message.object_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_msgs::srv::DetectObject_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_msgs::srv::DetectObject_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_msgs::srv::DetectObject_Request *>(
    untyped_ros_message);
...
{
  return &robot_msgs::srv::typesupport_fastrtps_cpp::_DetectObject_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_msgs, srv, DetectObject_Request)() {
  return &robot_msgs::srv::typesupport_fastrtps_cpp::_DetectObject_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robot_msgs
cdr_serialize(
  const robot_msgs::srv::DetectObject_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: found
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_msgs::srv::DetectObject_Response & ros_message)
{
  // Member: found
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_msgs::srv::DetectObject_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_msgs::srv::DetectObject_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robot_msgs::srv::DetectObject_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robot_msgs::srv::typesupport_fastrtps_cpp::_DetectObject_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_msgs, srv, DetectObject_Response)() {
  return &robot_msgs::srv::typesupport_fastrtps_cpp::_DetectObject_Response__handle;
}
...
{
  return &robot_msgs::srv::typesupport_fastrtps_cpp::_DetectObject__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_msgs, srv, DetectObject)() {
  return &robot_msgs::srv::typesupport_fastrtps_cpp::_DetectObject__handle;
}
