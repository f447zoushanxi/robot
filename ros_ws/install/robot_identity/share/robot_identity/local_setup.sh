...
: ${AMENT_CURRENT_PREFIX:="/ws/ros_ws/install/robot_identity"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_identity/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_identity/environment/path.sh"
