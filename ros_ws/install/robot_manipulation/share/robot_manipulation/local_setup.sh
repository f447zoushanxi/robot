...
: ${AMENT_CURRENT_PREFIX:="/ws/ros_ws/install/robot_manipulation"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_manipulation/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_manipulation/environment/path.sh"
